...
CREATE TABLE IF NOT EXISTS `Province` (
  ...
  `Alias`      char(1)          NULL     COMMENT '省份代号' COLLATE 'utf8mb4_general_ci',
...
CREATE TABLE IF NOT EXISTS `City` (
  ...
  `Name`       varchar(50)      NOT NULL COMMENT '城市名称' COLLATE 'utf8mb4_general_ci',
  `Acronym`    varchar(50)      NULL     COMMENT '名称缩写' COLLATE 'ascii_general_ci',
...
CREATE TABLE IF NOT EXISTS `District` (
  ...
  `Name`       varchar(50)      NOT NULL COMMENT '区县名称' COLLATE 'utf8mb4_general_ci',
  `Acronym`    varchar(50)      NULL     COMMENT '名称缩写' COLLATE 'ascii_general_ci',
...
CREATE TABLE IF NOT EXISTS `Street` (
  ...
  `Name`       varchar(50)      NOT NULL COMMENT '街道名称' COLLATE 'utf8mb4_general_ci',
  `Acronym`    varchar(50)      NULL     COMMENT '名称缩写' COLLATE 'ascii_general_ci',
  `PostalCode` char(6)          NULL     COMMENT '邮政编码' COLLATE 'ascii_general_ci',
